...
export const INSTITUTION_REQUESTS_ROUTE = '/institutions/:institutionId/requests';
...
export const institutionRequestsRoute = (institutionId: string) => `/institutions/${institutionId}/requests`;
